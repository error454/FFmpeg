...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--enable-gpl --extra-cflags='-march=armv7-a -march=armv7-a -ftree-vectorize -mfpu=neon -mfloat-abi=softfp'
prefix=/usr/local
...
EXTRALIBS=-ldl -lasound -L/usr/lib -lSDL -lm -pthread -lz 
INSTALL=install
LIBTARGET=
