...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--enable-gpl --extra-cflags='-march=armv7-a -mtune=cortex-a8 -mfpu=neon -ftree-vectorize -mfloat-abi=softfp'
prefix=/usr/local
...
CC_IDENT=gcc 4.2.1 (CodeSourcery Sourcery G++ Lite 2007q3-51)
ARCH=arm
CC=gcc
AS=gcc
LD=gcc
...
CFLAGS= -march=armv7-a -mtune=cortex-a8 -mfpu=neon -ftree-vectorize -mfloat-abi=softfp  -std=c99 -fomit-frame-pointer -marm -pthread -D_GNU_SOURCE=1 -D_REENTRANT -I/usr/local/include/SDL -g -Wdeclaration-after-statement -Wall -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wno-pointer-sign -Wcast-qual -Wwrite-strings -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -O3 -fno-math-errno -fno-tree-vectorize -Werror=implicit-function-declaration -Werror=missing-prototypes
ASFLAGS= -march=armv7-a -mtune=cortex-a8 -mfpu=neon -ftree-vectorize -mfloat-abi=softfp  -g
AS_O=-o $@
CC_O=-o $@
...
EXTRALIBS=-ldl -lasound -Wl,-rpath,/usr/local/lib -L/usr/local/lib -lSDL -lpthread -lm -pthread 
INSTALL=install
LIBTARGET=
...
libavcodec_VERSION=53.11.0
libavcodec_VERSION_MAJOR=53
libavdevice_VERSION=53.3.0
libavdevice_VERSION_MAJOR=53
libavformat_VERSION=53.8.0
libavformat_VERSION_MAJOR=53
libavutil_VERSION=51.12.0
libavutil_VERSION_MAJOR=51
libavfilter_VERSION=2.32.0
