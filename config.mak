...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--extra-cflags='-march=armv7-a' --extra-cflags=-ftree-vectorize --extra-cflags='-mfpu=neon' --extra-cflags='-mfloat-abi=softfp' --extra-cflags='-mtune=cortex-a8' --extra-cflags=-marm --prefix=/home/error454/projects/webos/mplayer2-build-2.0/build_libs --enable-gpl --disable-debug --enable-pthreads --disable-shared --enable-static --enable-postproc --disable-devices --disable-ffmpeg --disable-ffplay --disable-ffserver --disable-ffprobe --disable-vaapi
prefix=/home/error454/projects/webos/mplayer2-build-2.0/build_libs
...
CC_IDENT=gcc 4.5.2 (Sourcery G++ Lite 2011.03-41)
ARCH=arm
CC=gcc
CXX=g++
AS=gcc
...
EXTRALIBS=-L/usr/lib -lSDL -lm -pthread -lz 
INSTALL=install
LIBTARGET=
...
VCODEC_TESTS=amv asv1 asv2 dnxhd_1080i dnxhd_720p dnxhd_720p_10bit dnxhd_720p_rd dv dv50 error ffv1 flashsv flashsv2 flv h261 h263 h263p huffyuv jpeg2000 jpegls ljpeg mjpeg mpeg mpeg1b mpeg2 mpeg2thread mpeg4 mpeg4adv mpeg4nr mpeg4thread msmpeg4 msmpeg4v2 msvideo1 prores qtrle qtrlegray rc rgb roq rv10 rv20 snow snowll svq1 vref wmv1 wmv2 yuv 
